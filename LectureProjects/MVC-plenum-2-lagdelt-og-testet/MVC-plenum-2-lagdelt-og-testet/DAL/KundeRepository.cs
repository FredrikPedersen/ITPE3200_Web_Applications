...
namespace MVC_plenum_2.DAL
{
    public class KundeRepository : DAL.IKundeRepository
    {
        ...
        public bool settInn(Kunde innKunde)
        {
            ...
            try
            {  
                var eksistererPostnr = db.Poststeder.FirstOrDefault(p => p.Postnr == innKunde.postnr);
        ...
        public bool endreKunde(int id, Kunde innKunde)
        {
            ...
            try
            {
                Kunder endreKunde = db.Kunder.FirstOrDefault(k => k.ID == id);
        ...
        public bool slettKunde(int slettId)
        {
            ...
            try
            {
                Kunder slettKunde = db.Kunder.FirstOrDefault(k => k.ID == slettId);
